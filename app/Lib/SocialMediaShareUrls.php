...
/**
 * Class Social Media Share Urls
 *
 * @see https://github.com/bradvin/social-share-urls
 */
class SocialMediaShareUrls
{
    ...
    public function getSocialMediaSitesNiceNames()
    {
        return [
            'add.this'=>'AddThis',
            'blogger'=>'Blogger',
    ...
    public function getSocialMediaSitesWithShareLinksOrderedByPopularity()
    {
        return [
            'google.bookmarks',
            'facebook',
    ...
    public function getSocialMediaSitesWithShareLinksOrderedByAlphabet()
    {
        $nice_names = $this->getSocialMediaSitesNiceNames();
    ...
    public function getSocialMediaSiteLinksWithShareLinks($args)
    {
        ...
        return [
            ...
            'flattr'=>'https://flattr.com/submit/auto?user_id=' . $user_id . '&url=' . $url . '&title=' . $title .
                '&description=' . $text . '&language=' . $language . '&tags=' . $hash_tags .
                '&hidden=HIDDEN&category=' . $category,
            'flipboard'=>'https://share.flipboard.com/bookmarklet/popout?v=2&title=' . $text . '&url=' . $url,
            'gmail'=>'https://mail.google.com/mail/?view=cm&to=' . $email_address . '&su=' . $title .
                '&body=' . $url . '&bcc=' . $bcc_email_address . '&cc=' . $cc_email_address,
            'google.bookmarks'=>'https://www.google.com/bookmarks/mark?op=edit&bkmk=' . $url . '&title=' . $title .
                '&annotation=' . $text . '&labels=' . $hash_tags . '',
            ...
            'renren'=>'http://widget.renren.com/dialog/share?resourceUrl=' . $url . '&srcUrl=' . $url .
                '&title=' . $text . '&description=' . $desc,
            'skype'=>'https://web.skype.com/share?url=' . $url . '&text=' . $text,
            'sms'=>'sms:' . $phone_number . '?body=' . $text,
            'surfingbird.ru'=>'http://surfingbird.ru/share?url=' . $url . '&description=' . $desc .
                '&screenshot=' . $image . '&title=' . $title,
            ...
            'weibo'=>'http://service.weibo.com/share/share.php?url=' . $url . '&appkey=&title=' . $title .
                '&pic=&ralateUid=',
